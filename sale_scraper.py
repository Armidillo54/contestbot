...
STORES = [
    {
        ...
        'short': 'tiptop',
        'urls': [
            'https://www.tiptop.ca/en/collections/sale',
            'https://www.tiptop.ca/en/pages/promotions',
        ],
        'category': 'Menswear',
    },
    {
        ...
        'urls': [
            ...
            'https://www.marks.com/en/promotions',
        ],
    ...
    },
    {
        ...
        'short': 'sportchek',
        'urls': [
            'https://www.sportchek.ca/en/sale',
            'https://www.sportchek.ca/en/promotions',
        ],
    ...
    },
    {
        ...
        'short': 'joefresh',
        'urls': [
            'https://www.joefresh.com/ca/Sale',
            'https://www.joefresh.com/ca/collections/sale',
        ],
        'category': 'Clothing',
    },
    {
        ...
        'short': 'hmkids',
        'urls': [
            'https://www2.hm.com/en_ca/kids/sale.html',
            'https://www2.hm.com/en_ca/sale/kids.html',
        ],
    ...
    },
    {
        ...
        'urls': [
            ...
            'https://www.reitmans.com/en/promotions',
        ],
    ...
    },
    {
        ...
        'short': 'rwandco',
        'urls': [
            'https://www.rwandco.com/en/promotions',
            'https://www.rwandco.com/en/sale',
        ],
        'category': 'Clothing',
    },
]
